			...
			sidebar: [
				...
				{ label: 'Coverage', slug: 'coverage' },
				{
					...
					items: [
						...
						{ label: 'KYB Pipeline', slug: 'guides/kyb-pipeline' },
						{ label: 'AML & Beneficial Ownership', slug: 'guides/aml-beneficial-ownership' },
						{ label: 'Lead Enrichment', slug: 'guides/lead-enrichment' },
